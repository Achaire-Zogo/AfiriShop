  ...
  Future<List<ProductInfo>> fetchProductInfoFromApi() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<ProductInfo> productInfoList = data.map((item) {
          final Product product = Product.fromJson(item);
          return ProductInfo(
            nomProduit: product.nomProduit,
            dateVente: product.creationDate,
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //   child: EntreeRecente(
                //     date:
                //         DateFormat('yyyy-MM-dd').format(productInfo.dateVente),
                //     descriptionProduit: productInfo.nomProduit,
                //     prix: 0.0, // Mettez le prix correct ici
