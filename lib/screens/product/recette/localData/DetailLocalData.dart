...
class DetailLocalProduct extends StatefulWidget {
  const DetailLocalProduct({super.key,required this.myprod});
  final RecetteModel myprod;

  @override
  State<DetailLocalProduct> createState() => _DetailLocalProductState(myprod);
}

class _DetailLocalProductState extends State<DetailLocalProduct> {

  late final RecetteModel myprod;
  _DetailLocalProductState(this.myprod,) {
    super.initState();
  }
