...
class TextFieldWidget extends StatelessWidget {
  ...
  final List<TextInputFormatter>? inputFormatters; // Ajout de la propriété inputFormatters
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(
        ...
        inputFormatters: inputFormatters, // Utilisation de la propriété inputFormatters
